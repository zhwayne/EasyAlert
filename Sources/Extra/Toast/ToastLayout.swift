...
final class ToastLayout: AlertableLayout {
    ...
    func updateLayoutConstraints(context: LayoutContext, layoutGuide: LayoutGuide) {
        ...
        // Sizing: width intrinsic by default to fit within safe area minus insets
        ...
        case .intrinsic:
            // For toasts, intrinsic width allows the view to size itself within available space
        ...
        case .intrinsic:
            // For toasts, intrinsic height allows the view to size itself within available space
            let safeInsets = container.safeAreaInsets
